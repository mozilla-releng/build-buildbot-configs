...
sourceRepoRevision         = '8289e10542da'
relbranchOverride          = ''
mozillaRepoPath            = 'releases/mozilla-1.9.1'
mozillaRepoRevision        = 'FIREFOX_3_5_8_RELEASE'
mozillaRelbranchOverride   = 'GECKO1918_20100202_RELBRANCH' # put Gecko relbranch here that we base upon
...
milestone                  = '1.9.1.8'
buildNumber                = 1
baseTag                    = 'SEAMONKEY_2_0_3'
oldVersion                 = '2.0.2'
oldAppVersion              = oldVersion
oldBuildNumber             = 1
oldBaseTag                 = 'SEAMONKEY_2_0_2'
enUSPlatforms              = ('linux', 'linux64', 'win32', 'macosx')
l10nPlatforms              = ('win32',) #('linux', 'win32', 'macosx')
