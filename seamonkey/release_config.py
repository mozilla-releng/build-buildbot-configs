...
milestone                  = '1.9.1.4'
buildNumber                = 2
baseTag                    = 'SEAMONKEY_2_0'
oldVersion                 = '2.0rc2'
oldAppVersion              = '2.0'
oldBuildNumber             = 3
oldBaseTag                 = 'SEAMONKEY_2_0rc2'
