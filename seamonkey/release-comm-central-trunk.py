...
sourceRepoRevision         = 'd24027998497'
relbranchOverride          = 'COMM20b4_20100815_RELBRANCH'
mozillaRepoPath            = 'mozilla-central'
mozillaRepoRevision        = '5e9c05dbe8d6'
mozillaRelbranchOverride   = 'COMM20b4_20100815_RELBRANCH' # put Gecko relbranch here that we base upon
inspectorRepoPath          = 'dom-inspector' # leave empty if inspector is not to be tagged
inspectorRepoRevision      = 'eef568e4ee05'
inspectorRelbranchOverride = 'COMM20b4_20100815_RELBRANCH'
venkmanRepoPath            = 'venkman' # leave empty if venkman is not to be tagged
venkmanRepoRevision        = '5d2f0995baff'
