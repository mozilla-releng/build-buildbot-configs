...
mozillaRepoRevision        = 'FIREFOX_3_5_11_RELEASE'
mozillaRelbranchOverride   = 'GECKO19111_20100701_RELBRANCH' # put Gecko relbranch here that we base upon
...
milestone                  = '1.9.1.11'
buildNumber                = 1
baseTag                    = 'SEAMONKEY_2_0_6'
oldVersion                 = '2.0.5'
oldAppVersion              = oldVersion
oldBuildNumber             = 1
oldBaseTag                 = 'SEAMONKEY_2_0_5'
