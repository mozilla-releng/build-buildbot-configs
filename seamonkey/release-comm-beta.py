...
releaseConfig['version']                    = '2.11b3'
releaseConfig['appVersion']                 = '2.11'
releaseConfig['milestone']                  = '14.0'
releaseConfig['buildNumber']                = 1
releaseConfig['baseTag']                    = 'SEAMONKEY_2_11b3'
#  Old version info
releaseConfig['oldVersion']                 = '2.11b2'
releaseConfig['oldAppVersion']              = '2.11'
releaseConfig['oldBuildNumber']             = 1
releaseConfig['oldBaseTag']                 = 'SEAMONKEY_2_11b2'
...
releaseConfig['sourceRepoRevision']         = 'cd7e03be21f6'
...
releaseConfig['mozillaRepoRevision']        = 'FIREFOX_14_0b8_BUILD1'
releaseConfig['mozillaRelbranchOverride']   = 'GECKO140_2012061918_RELBRANCH' # put Gecko relbranch here that we base upon
#   Inspector
