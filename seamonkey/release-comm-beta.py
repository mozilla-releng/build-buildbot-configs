...
releaseConfig['version']                    = '2.16b3'
releaseConfig['appVersion']                 = '2.16'
releaseConfig['milestone']                  = '19.0'
releaseConfig['buildNumber']                = 1
releaseConfig['baseTag']                    = 'SEAMONKEY_2_16b3'
#  Old version info
releaseConfig['oldVersion']                 = '2.16b2'
releaseConfig['oldAppVersion']              = '2.16'
releaseConfig['oldBuildNumber']             = 1
releaseConfig['oldBaseTag']                 = 'SEAMONKEY_2_16b2'
...
releaseConfig['sourceRepoRevision']         = '5ddc32eb5a1b'
...
releaseConfig['mozillaRepoRevision']        = 'FIREFOX_19_0b4_BUILD1'
releaseConfig['mozillaRelbranchOverride']   = 'GECKO190_2013013010_RELBRANCH' # put Gecko relbranch here that we base upon
#   Inspector
