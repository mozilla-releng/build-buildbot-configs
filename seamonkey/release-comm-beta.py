...
sourceRepoRevision         = 'd3f6b76c1bee'
relbranchOverride          = ''
mozillaRepoPath            = 'releases/mozilla-beta'
mozillaRepoRevision        = 'FIREFOX_6_0b3_BUILD2'
mozillaRelbranchOverride   = 'GECKO60_2011072114_RELBRANCH' # put Gecko relbranch here that we base upon
inspectorRepoPath          = 'dom-inspector' # leave empty if inspector is not to be tagged
inspectorRepoRevision      = '697016a1e944'
inspectorRelbranchOverride = 'DOMI_2_0_10_RELEASE'
