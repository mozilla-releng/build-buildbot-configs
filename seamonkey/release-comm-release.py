...
sourceRepoRevision         = '4e789e5a01e5'
relbranchOverride          = 'COMM50_20110703_RELBRANCH'
mozillaRepoPath            = 'releases/mozilla-release'
mozillaRepoRevision        = '7b56ff900c2a'
mozillaRelbranchOverride   = 'COMM50_20110703_RELBRANCH' # put Gecko relbranch here that we base upon
inspectorRepoPath          = 'dom-inspector' # leave empty if inspector is not to be tagged
inspectorRepoRevision      = '697016a1e944'
inspectorRelbranchOverride = 'COMM50_20110703_RELBRANCH'
venkmanRepoPath            = 'venkman' # leave empty if venkman is not to be tagged
venkmanRepoRevision        = '5e7659a617fa'
venkmanRelbranchOverride   = 'COMM50_20110703_RELBRANCH'
chatzillaRepoPath          = 'chatzilla' # leave empty if chatzilla is not to be tagged
chatzillaRepoRevision      = '144f0c279a3b'
chatzillaRelbranchOverride = 'COMM50_20110703_RELBRANCH'
l10nRepoPath               = 'releases/l10n/mozilla-release'
l10nRelbranchOverride      = 'COMM50_20110703_RELBRANCH'
