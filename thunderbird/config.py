...
BRANCHES['comm-1.9.2-unittest'] = {
    ...
    'client_py_extra_args': ['--mozilla-rev=COMM1918_20100202_RELBRANCH'],
    'platforms': {
        'linux': {
...
BRANCHES['comm-1.9.2']['client_py_args'] = DEFAULTS['client_py_args'] + ['--mozilla-repo=http://hg.mozilla.org/releases/mozilla-1.9.2'] + ['--mozilla-rev=COMM1918_20100202_RELBRANCH']
...
BRANCHES['comm-1.9.2-lightning']['client_py_args'] = ['--skip-comm', '--skip-chatzilla', '--skip-venkman']
...
BRANCHES['comm-1.9.2-bloat']['client_py_args'] = ['--skip-comm', '--skip-chatzilla', '--skip-venkman', '--hg-options=--verbose --time', '--mozilla-repo=http://hg.mozilla.org/releases/mozilla-1.9.2'] +  ['--mozilla-rev=COMM1918_20100202_RELBRANCH']
...
BRANCHES['comm-1.9.2-bloat']['tinderbox_tree'] = 'Thunderbird3.1'
