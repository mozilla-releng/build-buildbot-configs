...
gloConfig = {
    ...
    'beta': {
        ...
        'mozillaRepoRevision'        : '7c1525a92228',
        # 'If' blank, automation will create its own branch based on COMM_<date>_RELBRANCH
        # 'You' typically want to set this to the gecko relbranch if doing a release off
        # 'a' specific gecko version.
        'mozillaRelbranchOverride'   : 'COMM110_2012030905_RELBRANCH', # put Gecko relbranch here that we base upon
    ...
    'release': {
        ...
        'sourceRepoRevision'         : 'a43f913afae4',
        # 'If' blank, automation will create its own branch based on COMM_<date>_RELBRANCH
        'relbranchOverride'          : '',
        'mozillaRepoPath'            : 'releases/mozilla-release',
        'mozillaRepoRevision'        : 'db314cf8c6f2',
        # 'If' blank, automation will create its own branch based on COMM_<date>_RELBRANCH
        # 'You' typically want to set this to the gecko relbranch if doing a release off
        # 'a' specific gecko version.
