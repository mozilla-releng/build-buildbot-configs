...
gloConfig = {
    ...
    'beta': {
        ...
        'sourceRepoRevision'         : '33ee8cf6630f',
        # 'If' blank, automation will create its own branch based on COMM_<date>_RELBRANCH
        'relbranchOverride'          : '',
        'mozillaRepoPath'            : 'releases/mozilla-beta',
        'mozillaRepoRevision'        : '0ad498bb833f',
        # 'If' blank, automation will create its own branch based on COMM_<date>_RELBRANCH
        # 'You' typically want to set this to the gecko relbranch if doing a release off
        # 'a' specific gecko version.
        'mozillaRelbranchOverride'   : 'GECKO120_2012041716_RELBRANCH', # put Gecko relbranch here that we base upon
        ...
        'version'                    : '12.0b5',
        'oldVersion'                 : '12.0b4',
        'appVersion'                 : '12.0', # no 'b1' suffix for betas
        'oldAppVersion'              : '12.0',
        'buildNumber'                : 1,
        'oldBuildNumber'             : 1,
        'baseTag'                    : 'THUNDERBIRD_12_0b5',
        'oldBaseTag'                 : 'THUNDERBIRD_12_0b4',
        #XXX: 'Not' entirely certain if/where this is used.
        # 'Derived' from mozillaRelbranchOverride. eg: COMM19211_20101004_RELBRANCH == 1.9.2.11
        'milestone'                  : '12.0',
        # 'The' old version is the revision from which we should generate update snippets.
    ...
    'release': {
        ...
        'sourceRepoRevision'         : '37620e34f3a4',
        # 'If' blank, automation will create its own branch based on COMM_<date>_RELBRANCH
        'relbranchOverride'          : '',
        ...
        'milestone'                  : '12.0',
        'buildNumber'                : 1,
        'baseTag'                    : 'THUNDERBIRD_12_0',
        'oldVersion'                 : '11.0.1',
        'oldAppVersion'              : '11.0.1',
        'oldBuildNumber'             : 1,
        'oldBaseTag'                 : 'THUNDERBIRD_11_0_1',
        'enable_weekly_bundle'       : False,
        'enUSPlatforms'              : ('linux', 'linux64', 'win32', 'macosx64'),
        #'l10nPlatforms'              : (),
        'xulrunnerPlatforms'         : (),
    ...
    'esr10': {
        ...
        'sourceRepoRevision'         : 'f0e5d995d302',
        # 'If' blank, automation will create its own branch based on COMM_<date>_RELBRANCH
        'relbranchOverride'          : '',
        'mozillaRepoPath'            : 'releases/mozilla-esr10',
        'mozillaRepoRevision'        : 'b7f233ffae4b',
        # 'If' blank, automation will create its own branch based on COMM_<date>_RELBRANCH
        # 'You' typically want to set this to the gecko relbranch if doing a release off
        # 'a' specific gecko version.
        'mozillaRelbranchOverride'   : 'COMM1003_2012030601_RELBRANCH', # put Gecko relbranch here that we base upon
        'inspectorRepoPath'          : '', #'dom-inspector', # leave empty if inspector is not to be tagged
        'inspectorRepoRevision'      : '',
        'inspectorRelbranchOverride' : '',
        'buildToolsRepoPath'            : '', # leave empty if buildTools is not to be tagged
        ...
        # 'appVersion', not version.
        'version'                    : '10.0.3esr',
        'oldVersion'                 : '10.0.2esr',
        'appVersion'                 : '10.0.3', # no 'b1' suffix for betas
        'oldAppVersion'              : '10.0.2',
        'buildNumber'                : 1,
        'oldBuildNumber'             : 1,
        'baseTag'                    : 'THUNDERBIRD_10_0_3esr',
        'oldBaseTag'                 : 'THUNDERBIRD_10_0_2esr',
        #XXX: 'Not' entirely certain if/where this is used.
        # 'Derived' from mozillaRelbranchOverride. eg: COMM19211_20101004_RELBRANCH == 1.9.2.11
        'milestone'                  : '10.0.3',
        'enable_weekly_bundle'       : False,
