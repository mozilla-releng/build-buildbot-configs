...
gloConfig = {
    '31': {
        ...
        'sourceRepoRevision'         : 'ce1c3a8fa276',
        # 'If' blank, automation will create its own branch based on COMM_<date>_RELBRANCH
        'relbranchOverride'          : '',
        'mozillaRepoPath'            : 'releases/mozilla-1.9.2',
        'mozillaRepoRevision'        : '489b4f2582a3',
        # 'If' blank, automation will create its own branch based on COMM_<date>_RELBRANCH
        # 'You' typically want to set this to the gecko relbranch if doing a release off
        # 'a' specific gecko version.
        'mozillaRelbranchOverride'   : 'GECKO19225_2011121210_RELBRANCH', # put Gecko relbranch here that we base upon
        ...
        'milestone'                  : '1.9.2.25',
        'buildNumber'                : 1,
        'baseTag'                    : 'THUNDERBIRD_3_1_17',
        # 'The' old version is the revision from which we should generate update snippets.
        'oldVersion'                 : '3.1.16',
        #'oldAppVersion'              : oldVersion,
        'oldBuildNumber'             : 2,
        'oldBaseTag'                 : 'THUNDERBIRD_3_1_16',
    ...
    'beta': {
        ...
        'sourceRepoRevision'         : 'fabf6e73f3b6',
        # 'If' blank, automation will create its own branch based on COMM_<date>_RELBRANCH
        'relbranchOverride'          : '',
        ...
        # 'You' typically want to set this to the gecko relbranch if doing a release off
        # 'a' specific gecko version.
        'mozillaRelbranchOverride'   : 'GECKO100_2012011108_RELBRANCH', # put Gecko relbranch here that we base upon
        'inspectorRepoPath'          : '', #'dom-inspector', # leave empty if inspector is not to be tagged
        ...
        'buildNumber'                : 1,
        'oldBuildNumber'             : 1,
        'baseTag'                    : 'THUNDERBIRD_10_0b3',
        'oldBaseTag'                 : 'THUNDERBIRD_10_0b2',
        #XXX: 'Not' entirely certain if/where this is used.
        # 'Derived' from mozillaRelbranchOverride. eg: COMM19211_20101004_RELBRANCH == 1.9.2.11
        'milestone'                  : '10.0',
        # 'The' old version is the revision from which we should generate update snippets.
