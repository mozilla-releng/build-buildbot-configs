SLAVES = {
    'n810': ['maemo-n810-%02i' % x for x in range(1,7) + range(10,41)],
}
...
BRANCHES['mozilla-central']['graph_server'] = "graphs-old.mozilla.org"
...
BRANCHES['mozilla-1.9.2']['graph_server'] = "graphs-old.mozilla.org"
...
BRANCHES['tracemonkey']['graph_server'] = "graphs-old.mozilla.org"
