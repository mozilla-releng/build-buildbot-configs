...
BRANCHES['comm-central']['platforms']['linux']['mochitest_leakthreshold'] = '22724'
BRANCHES['comm-central']['platforms']['win32']['mochitest_leakthreshold'] = '22805'
BRANCHES['comm-central']['platforms']['macosx']['mochitest_leakthreshold'] = '22740'
BRANCHES['comm-central']['platforms']['linux']['mochichrome_leakthreshold'] = '8556'
BRANCHES['comm-central']['platforms']['win32']['mochichrome_leakthreshold'] = '8517'
BRANCHES['comm-central']['platforms']['macosx']['mochichrome_leakthreshold'] = '8572'
BRANCHES['comm-central']['platforms']['linux']['mochibrowser_leakthreshold'] = '8676'
BRANCHES['comm-central']['platforms']['win32']['mochibrowser_leakthreshold'] = '8637'
BRANCHES['comm-central']['platforms']['macosx']['mochibrowser_leakthreshold'] = '8692'
