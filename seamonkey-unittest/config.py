...
BRANCHES['comm-central']['platforms']['linux']['mochitest_leakthreshold'] = '0'
BRANCHES['comm-central']['platforms']['win32']['mochitest_leakthreshold'] = '200'
BRANCHES['comm-central']['platforms']['macosx']['mochitest_leakthreshold'] = '1112'
BRANCHES['comm-central']['platforms']['linux']['mochichrome_leakthreshold'] = '1112'
BRANCHES['comm-central']['platforms']['win32']['mochichrome_leakthreshold'] = '1112'
BRANCHES['comm-central']['platforms']['macosx']['mochichrome_leakthreshold'] = '1232'
BRANCHES['comm-central']['platforms']['linux']['mochibrowser_leakthreshold'] = '1112'
BRANCHES['comm-central']['platforms']['win32']['mochibrowser_leakthreshold'] = '1112'
BRANCHES['comm-central']['platforms']['macosx']['mochibrowser_leakthreshold'] = '1232'
