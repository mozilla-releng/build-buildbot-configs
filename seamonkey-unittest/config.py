...
BRANCHES['comm-central']['platforms']['linux']['mochitest_leakthreshold'] = '8'
BRANCHES['comm-central']['platforms']['win32']['mochitest_leakthreshold'] = '208'
BRANCHES['comm-central']['platforms']['macosx']['mochitest_leakthreshold'] = '1120'
BRANCHES['comm-central']['platforms']['linux']['mochichrome_leakthreshold'] = '0'
BRANCHES['comm-central']['platforms']['win32']['mochichrome_leakthreshold'] = '0'
BRANCHES['comm-central']['platforms']['macosx']['mochichrome_leakthreshold'] = '1112'
