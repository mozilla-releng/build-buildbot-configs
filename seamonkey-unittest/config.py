...
BRANCHES['comm-central']['platforms']['linux']['mochitest_leakthreshold'] = '143116'
BRANCHES['comm-central']['platforms']['win32']['mochitest_leakthreshold'] = '21493'
BRANCHES['comm-central']['platforms']['macosx']['mochitest_leakthreshold'] = '21428'
BRANCHES['comm-central']['platforms']['linux']['mochichrome_leakthreshold'] = '8568'
BRANCHES['comm-central']['platforms']['win32']['mochichrome_leakthreshold'] = '8525'
BRANCHES['comm-central']['platforms']['macosx']['mochichrome_leakthreshold'] = '8580'
BRANCHES['comm-central']['platforms']['linux']['mochibrowser_leakthreshold'] = '8688'
BRANCHES['comm-central']['platforms']['win32']['mochibrowser_leakthreshold'] = '8645'
BRANCHES['comm-central']['platforms']['macosx']['mochibrowser_leakthreshold'] = '8700'
