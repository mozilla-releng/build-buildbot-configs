...
BRANCHES['comm-central']['platforms']['linux']['mochitest_leakthreshold'] = '21484'
BRANCHES['comm-central']['platforms']['win32']['mochitest_leakthreshold'] = '21561'
BRANCHES['comm-central']['platforms']['macosx']['mochitest_leakthreshold'] = '21496'
BRANCHES['comm-central']['platforms']['linux']['mochichrome_leakthreshold'] = '8636'
BRANCHES['comm-central']['platforms']['win32']['mochichrome_leakthreshold'] = '8593'
BRANCHES['comm-central']['platforms']['macosx']['mochichrome_leakthreshold'] = '8648'
BRANCHES['comm-central']['platforms']['linux']['mochibrowser_leakthreshold'] = '8756'
BRANCHES['comm-central']['platforms']['win32']['mochibrowser_leakthreshold'] = '8713'
BRANCHES['comm-central']['platforms']['macosx']['mochibrowser_leakthreshold'] = '8768'
