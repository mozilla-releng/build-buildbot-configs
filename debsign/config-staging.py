...
CANDIDATES_RELEASE_ENV = {
    ...
    'BASE_STAGE_URL': 'http://staging-mobile-master.build.mozilla.org/debtest/candidates',
    'SSH_KEY': '/home/cltbld/.ssh/id_rsa',
    'SIGNDEBS_BASEDIR': 'sign-debs-staging',
}
...
DEBSIGN_CONFIG['branches']['1.9.2']['release_base_xulrunner_url'] = 'http://staging-mobile-master.build.mozilla.org/candidates/1.0-candidates/build1/maemo/multi'
...
TRIGGER_CONFIG['release_base_url'] = 'http://staging-mobile-master.build.mozilla.org/candidates/1.0-candidates/build1/maemo'
