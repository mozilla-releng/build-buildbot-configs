...
CANDIDATES_RELEASE_ENV = {
    ...
    'BASE_STAGE_PATH': '/home/ftp',
    'BASE_STAGE_URL': 'http://ftp.mozilla.org',
    'STAGE_DIR': '/pub/mozilla.org/mobile/candidates/1.0rc3-candidates/repos',
    'SSH_KEY': '/home/cltbld/.ssh/ffxbld_dsa',
}
...
DEBSIGN_CONFIG['branches']['1.9.2']['release_stage_dir'] = '/pub/mozilla.org/mobile/candidates/1.0rc3-candidates/build1/maemo'
...
TRIGGER_CONFIG['branches']['1.9.2']['release_mobile_tag'] = 'FENNEC_1_0rc3_RELEASE'
