...
DEBSIGN_CONFIG['branches']['1.9.2']['release_base_xulrunner_url'] = 'http://ftp.mozilla.org/pub/mozilla.org/mobile/candidates/1.0rc1-candidates/build1/maemo/multi'
...
TRIGGER_CONFIG['release_base_url'] = 'http://ftp.mozilla.org/pub/mozilla.org/mobile/candidates/1.0rc1-candidates/build1/maemo'
