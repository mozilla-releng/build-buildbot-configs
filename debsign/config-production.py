...
BRANCHES["mozilla-beta"]["release_config_file"] = "deb_repos/release_mozilla-beta.json"
...
BRANCHES["mozilla-release"]["release_config_file"] = "deb_repos/release_mozilla-release.json"
