...
releaseConfig['sourceRepoRevision']  = '5d2cbf9c9669'
...
releaseConfig['version']             = '3.6.13'
releaseConfig['appVersion']          = releaseConfig['version']
releaseConfig['milestone']           = '1.9.2.13'
releaseConfig['buildNumber']         = 1
releaseConfig['baseTag']             = 'FIREFOX_3_6_13'
releaseConfig['oldVersion']          = '3.6.12'
releaseConfig['oldAppVersion']       = releaseConfig['oldVersion']
releaseConfig['oldBuildNumber']      = 1
releaseConfig['oldBaseTag']          = 'FIREFOX_3_6_12'
