...
releaseConfig['version']             = '39.0b7'
releaseConfig['appVersion']          = '39.0'
releaseConfig['milestone']           = releaseConfig['appVersion']
releaseConfig['buildNumber']         = 1
releaseConfig['baseTag']             = 'FIREFOX_39_0b7'
releaseConfig['partialUpdates']      = {

    '39.0b6': {
        'appVersion': '39.0',
        'buildNumber': 1,
        'baseTag': 'FIREFOX_39_0b6',
    },

    '39.0b4': {
        'appVersion': '39.0',
        'buildNumber': 2,
        'baseTag': 'FIREFOX_39_0b4',
    },

    '39.0b5': {
        'appVersion': '39.0',
        'buildNumber': 1,
        'baseTag': 'FIREFOX_39_0b5',
    },
