...
WIN64_IXS      = ['w64-ix-slave%03i' % x for x in range(139,158)]
WIN64_REV2     = ['w64-ix-slave%02i' % x for x in range(6,30) + range(42,44) + range(75,100) if x not in [22,80,85,86]] + \
                 ['w64-ix-slave%03i' % x for x in range(100,110) + range(111,139)]
...
BRANCHES = {
    ...
    'mozilla-b2g26_v1_2f': {
        'packaged_unittest_tinderbox_tree': 'Mozilla-B2g26-v1.2f',
