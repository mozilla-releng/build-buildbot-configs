...
MOCK_IX        = ['bld-linux64-ix-%03d' % x for x in [4] + range(15, 38)]
...
TRY_MOCK_IX      = ['bld-linux64-ix-%03d' % x for x in range(38, 74)]
TRY_LION         = ['bld-lion-r5-%03d' % x for x in range(16,41) + [95,96]]
