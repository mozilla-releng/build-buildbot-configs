...
c['buildbotURL'] = 'http://buildbot-master2.build.scl1.mozilla.com:8010/'
...
ACTIVE_BRANCHES = ['shadow-central', 'mozilla-1.9.1', 'mozilla-1.9.2', 'mozilla-central',
        'mozilla-2.0', 'mozilla-2.1', 'mozilla-beta', 'mozilla-aurora', 'mozilla-release',
...
RESERVED_SLAVES = "reserved_slaves_bm02"
