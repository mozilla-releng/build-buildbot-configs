releaseConfig['sourceRepositories']['mozilla']['path'] = 'users/prepr-ffxbld/mozilla-1.9.1'
releaseConfig['sourceRepositories']['mozilla']['clonePath'] = 'releases/mozilla-1.9.1'
