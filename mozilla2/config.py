...
BRANCHES['mozilla-central']['platforms']['linux']['build_space'] = 5.2
BRANCHES['mozilla-central']['platforms']['linux64']['build_space'] = 5
BRANCHES['mozilla-central']['platforms']['win32']['build_space'] = 7.4
BRANCHES['mozilla-central']['platforms']['wince']['build_space'] = 4
BRANCHES['mozilla-central']['platforms']['macosx']['build_space'] = 5.2
...
BRANCHES['mozilla-central']['enable_checktests'] = True
...
BRANCHES['mozilla-1.9.1']['enable_checktests'] = False
...
BRANCHES['mozilla-1.9.2']['enable_checktests'] = False
...
BRANCHES['tracemonkey']['enable_checktests'] = True
...
BRANCHES['places']['enable_checktests'] = True
...
BRANCHES['electrolysis']['enable_checktests'] = True
